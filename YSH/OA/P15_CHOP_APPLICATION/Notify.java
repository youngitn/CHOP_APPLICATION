...
//YSH/OA/P15_CHOP_APPLICATION/Notify;
...
public class Notify extends bNotify {
	...
	public void actionPerformed(String value) throws Throwable {
		...
		String sqlcommString = "SELECT F_INP_INFO FROM CHOP_APPLICATION_FLOWC where PNO =  '"
				+ convert.ToSql(PNO) + "' ";
		...
		String title = "(" + EMPID + ")" + name + "之用印項目暨核決權限申請表( " + PNO + " ). "
				+ backTitleString;
		String content = "";
		content += "主旨:" + title + "<br>";
